...
/**
 * Exception thrown when an attempt is made to reactivate a ticket that is already active.
 */
public class TicketAlreadyReactivatedException extends TicketSalesManagerException {

    /**
     * Constructs a new TicketAlreadyReactivatedException with specified user and log messages.
     *
