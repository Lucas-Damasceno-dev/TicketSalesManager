...
/**
 * Exception thrown when an attempt is made to cancel a ticket that cannot be canceled.
 */
public class TicketNotCancelableException extends TicketSalesManagerException {

    /**
     * Constructs a new TicketNotCancelableException with specified user and log messages.
     *
