...
/**
 * Exception thrown when an attempt is made to create a ticket that already exists.
 */
public class TicketAlreadyExistsException extends TicketSalesManagerException {

    /**
     * Constructs a new TicketAlreadyExistsException with specified user and log messages.
     *
