...
/**
 * Exception thrown when a user registration attempt fails due to the user already existing.
 */
public class UserAlreadyExistsException extends TicketSalesManagerException {

    /**
     * Constructs a new UserAlreadyExistsException with a specified user login.
     *
     * @param userLogin The login of the user that already exists.
     */
