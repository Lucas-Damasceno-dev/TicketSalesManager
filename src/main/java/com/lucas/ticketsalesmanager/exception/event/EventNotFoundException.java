 ...
 * The error message to the user indicates that the event was not found,
 * while the message to the log details the ID of the event that was not found.
 *
...
public class EventNotFoundException extends TicketSalesManagerException {
    public EventNotFoundException(String eventId) {
        super("Event not found.",
                "Event with ID: " + eventId + " not found in the system.");
    }
}
